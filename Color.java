...
public class Color extends OpenCvPipeline {
    Scalar HOT_PINK = new Scalar(255, 35, 252);
    Scalar NEON_GREEN = new Scalar(57, 255, 20);
    Scalar PURPLE = new Scalar(236, 115, 255);

    public static Scalar scalarLowerYCrCb1 = new Scalar(0.0, 150.0, 120.0);
    public static Scalar scalarUpperYCrCb1 = new Scalar(255.0, 255.0, 255.0);

    public static Scalar scalarLowerYCrCb2 = new Scalar(0.0, 0.0, 0.0);
    public static Scalar scalarUpperYCrCb2 = new Scalar(255.0, 120.0, 120.0);

    public static Scalar scalarLowerYCrCb3 = new Scalar(0.0, 0.0, 0.0);
    public static Scalar scalarUpperYCrCb3 = new Scalar(255.0, 255.0, 255.0);
    ...
    public Color(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
        this.borderLeftX = borderLeftX;
        this.borderRightX = borderRightX;
        this.borderTopY = borderTopY;
        this.borderBottomY = borderBottomY;
    }
    public void configureScalarLower1(double y, double cr, double cb) {
        scalarLowerYCrCb1 = new Scalar(y, cr, cb);
    }
    public void configureScalarUpper1(double y, double cr, double cb) {
        scalarUpperYCrCb1 = new Scalar(y, cr, cb);
    }
    public void configureScalarLower1(int y, int cr, int cb) {
        scalarLowerYCrCb1 = new Scalar(y, cr, cb);
    }
    public void configureScalarUpper1(int y, int cr, int cb) {
        scalarUpperYCrCb1 = new Scalar(y, cr, cb);
    }
    ...
    public Mat processFrame(Mat input) {
        ...
        try {
            ...
            Core.inRange(mat, scalarLowerYCrCb1, scalarUpperYCrCb1, processed);
            Core.inRange(mat, scalarLowerYCrCb2, scalarUpperYCrCb2, processed);
            Core.inRange(mat, scalarLowerYCrCb3, scalarUpperYCrCb3, processed);
