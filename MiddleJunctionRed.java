...
@Autonomous(name="MiddleJunctionRed", group="Robot")

public class MiddleJunctionRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  19,  -21, 5.0);
        encoderCascade(.1  ,2 , 5.0);
        encoderDrive(DRIVE_SPEED,  -14,  -10, 5.0);
        intake.setPower(-1);
        sleep(1000);
