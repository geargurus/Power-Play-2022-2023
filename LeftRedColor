...
@Autonomous(name = "LeftRedColor")
public class LeftRedColor extends LinearOpMode {
    ...
    // 0.35 inches
    static final double DRIVE_SPOOL_GEAR_REDUCTION = 4.85;     // This is < 1.0 if geared UP
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Currently at", " at %7d :%7d :%7d :%7d", fr.getCurrentPosition(), fl.getCurrentPosition(), br.getCurrentPosition(), bl.getCurrentPosition());
                telemetry.update();
            }
            // Stop all motion;
            fr.setPower(0);
    ...
    public void liftDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            newVLTarget = VL.getCurrentPosition() + (int) (Inches * ROTATION_PER_INCH);
            newVRTarget = VR.getCurrentPosition() + (int) (Inches * ROTATION_PER_INCH);
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Currently at", " at %7d :%7d", VR.getCurrentPosition(), VL.getCurrentPosition());
                telemetry.update();
            }
            // Stop all motion;
            VL.setPower(0);
